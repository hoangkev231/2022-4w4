...
add_action('customize_register', function(WP_Customize_Manager $manager){
    ...
    $manager->add_setting('background_clippath',["default"=>"#ffffff","sanitize_callback"=>"sanitize_hex_color"]);
    ...
    $manager->add_control(new WP_Customize_Color_Control($manager,"background_body",["section"=>"apparence_body","label"=>"Choisir la couleur d'arrière plan"]));
});
